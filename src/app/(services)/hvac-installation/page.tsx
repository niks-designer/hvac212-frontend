...
export async function generateMetadata() {
    return generatePageMetadata("hvac-installation");
}

export default async function HvacInstallationPage() {
    const flexibleContent = await getPageContentBySlug("hvac-installation");

    return (
        <div className="relative min-h-screen overflow-hidden">
            <div className="bg-shapes">
                <div
                    className="pointer-events-none absolute top-95.75 -left-17.75 -z-10 h-375 w-[1582px] opacity-30"
                    style={{
                        background:
                            "radial-gradient(50% 50% at 50% 50%, rgba(252, 177, 22, 1) 0%, rgba(7, 15, 29, 0) 100%)",
                    }}
                    aria-hidden="true"
                />
                <div
