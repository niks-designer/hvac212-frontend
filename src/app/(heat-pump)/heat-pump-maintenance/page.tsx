...
export async function generateMetadata() {
    return generatePageMetadata("heat-pump-maintenance");
}

export default async function HeatPumpMaintenancePage() {
    const flexibleContent = await getPageContentBySlug("heat-pump-maintenance");
