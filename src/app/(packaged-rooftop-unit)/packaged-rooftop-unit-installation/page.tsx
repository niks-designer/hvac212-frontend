...
export async function generateMetadata() {
    return generatePageMetadata("packaged-rooftop-unit-installation");
}

export default async function PackagedRooftopUnitInstallationPage() {
