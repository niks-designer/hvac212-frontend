...
export async function generateMetadata() {
    return generatePageMetadata("furnace-repair");
}

export default async function FurnaceRepairPage() {
    const flexibleContent = await getPageContentBySlug("furnace-repair");
            ...
            {flexibleContent.length > 0 ? (
                ...
                <section className="px-4 py-24 text-center md:px-8 lg:px-16">
                    <div className="bg-secondary mx-auto max-w-3xl rounded-2xl border border-white/10 p-12">
                        <h1 className="text-3xl font-bold">Furnace Repair</h1>
                        <p className="mt-4">
