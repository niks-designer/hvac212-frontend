...
export async function generateMetadata() {
    return generatePageMetadata("vrf-vrv-installation");
}

export default async function VrfVrvInstallationPage() {
    const flexibleContent = await getPageContentBySlug("vrf-vrv-installation");
