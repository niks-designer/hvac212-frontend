...
export async function generateMetadata() {
    return generatePageMetadata("ductless-mini-split-maintenance");
}

export default async function DuctlessMiniSplitMaintenancePage() {
    const flexibleContent = await getPageContentBySlug("ductless-mini-split-maintenance");
