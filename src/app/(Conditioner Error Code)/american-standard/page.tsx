...
const americanStandardCodeGroups = [
    {
        id: "americanStandardAirConditioningCodes",
        title: "American Standard air conditioning codes",
        codes: [
            {
                id: "american-standard-1",
                code: "Green light on, slow flashing, or fast flashing",
                result: "Unit is operating normally.",
            },
            {
                id: "american-standard-2",
                code: "Amber light on",
                result: "Unit requires refrigerant.",
            },
            {
                id: "american-standard-3",
                code: "Red 1 flash",
                result: "Communication error.",
            },
            {
                id: "american-standard-4",
                code: "Red 2, 3, and 4 flashes",
                result: "Defrost fault.",
            },
            {
                id: "american-standard-5",
                code: "Red 5 flashes",
                result: "Fault with the ambient temperature sensor.",
            },
            {
                id: "american-standard-6",
                code: "Red 6 flashes",
                result: "Fault with the coil temperature sensor.",
            },
            {
                id: "american-standard-7",
                code: "Red 7 flashes",
                result: "Low-pressure problem.",
            },
            {
                id: "american-standard-8",
                code: "Red 13 flashes",
                result: "Fault with the external temperature sensor.",
            },
            {
                id: "american-standard-9",
                code: "Red 17 flashes",
                result: "High-pressure problem.",
            },
        ],
    },
];
...
const CodeSection = ({
    ...
    codes: (typeof americanStandardCodeGroups)[number]["codes"];
}) => (
...
export default function AmericanStandardPage() {
    ...
    const [expandedAccordion, setExpandedAccordion] = useState<string | null>(
        "americanStandardAirConditioningCodes"
    );
    ...
    return (
        <main className="american-standard-error-page relative min-h-screen overflow-hidden">
            ...
            <section className="relative flex h-140 items-center justify-center overflow-hidden md:h-90">
                <div className="absolute inset-0">
                    <Image
                        alt="American Standard Error Code Search"
                        loading="lazy"
                        width="1912"
                        height="610"
                        decoding="async"
                ...
                <div className="relative z-10 text-center text-white">
                    <h1 className="h1-title">American Standard</h1>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="sec-ttl mx-auto flex max-w-6xl flex-col gap-5 text-center lg:gap-8">
                        <h2 className="h2-title">
                            American Standard Error code search
                        </h2>
                        ...
                        <div className="error-btn">
                            ...
                            >
                                <div className="code-inner">
                                    {americanStandardCodeGroups.map((group) => (
                                        <div
                                            className="code-item"
                                            key={group.id}
                                        >
