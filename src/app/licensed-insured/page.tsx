    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            <div className="bg-shapes">
                {/* Background Shape 1 */}
                <div
                    className="pointer-events-none absolute top-65.5 -left-17.75 -z-10 h-375 w-[1582px] bg-[radial-gradient(50%_50%_at_50%_50%,rgba(0,191,255,0.36)_0%,rgba(7,15,29,0)_100%)]"
                    aria-hidden="true"
                />

                {/* Background Shape 2 */}
                <div
                    className="pointer-events-none absolute top-357.75 -left-62.5 -z-10 h-[1816px] w-[1916px] bg-[radial-gradient(50%_50%_at_50%_50%,rgba(228,187,76,0.36)_0%,rgba(7,15,29,0)_100%)]"
                    aria-hidden="true"
                />

                {/* Background Shape 3 */}
                <div
                    className="pointer-events-none absolute top-[2862px] left-121 -z-10 h-375 w-[1582px] bg-[radial-gradient(50%_50%_at_50%_50%,rgba(0,191,255,0.36)_0%,rgba(7,15,29,0)_100%)]"
                    aria-hidden="true"
                />
            </div>
