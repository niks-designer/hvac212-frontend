...
export async function generateMetadata() {
    return generatePageMetadata("heating-maintenance");
}

export default async function HeatingMaintenancePage() {
    const flexibleContent = await getPageContentBySlug("heating-maintenance");

    return (
        <div className="min-h-screen">
            <div className="absolute inset-0 -z-50 blur-[50px] in-[.light]:hidden">
                <Image
                    src="/images/page-bg/heating-maintenance-bg.webp"
                    alt="heating maintenance"
                    fill
                    priority
