...
export async function generateMetadata() {
    return generatePageMetadata("central-air-repair");
}

export default async function CentralAirRepairPage() {
    const flexibleContent = await getPageContentBySlug("central-air-repair");
