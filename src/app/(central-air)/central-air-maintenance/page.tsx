...
export async function generateMetadata() {
    return generatePageMetadata("central-air-maintenance");
}

export default async function CentralAirMaintenancePage() {
    const flexibleContent = await getPageContentBySlug("central-air-maintenance");
